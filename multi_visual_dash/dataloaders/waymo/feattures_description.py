...
def _generate_agent_features_by_timezone(timezone):
    ...
    return {
        f"state/{timezone}/x": tf.io.FixedLenFeature([128, n_values], tf.float32, default_value=None),
        f"state/{timezone}/y": tf.io.FixedLenFeature([128, n_values], tf.float32, default_value=None),
        f"state/{timezone}/z": tf.io.FixedLenFeature([128, n_values], tf.float32, default_value=None),

        f"state/{timezone}/velocity_x": tf.io.FixedLenFeature([128, n_values], tf.float32, default_value=None),
        f"state/{timezone}/velocity_y": tf.io.FixedLenFeature([128, n_values], tf.float32, default_value=None),
        f"state/{timezone}/speed": tf.io.FixedLenFeature([128, n_values], tf.float32, default_value=None),

        f"state/{timezone}/length": tf.io.FixedLenFeature([128, n_values], tf.float32, default_value=None),
        f"state/{timezone}/width": tf.io.FixedLenFeature([128, n_values], tf.float32, default_value=None),
        f"state/{timezone}/height": tf.io.FixedLenFeature([128, n_values], tf.float32, default_value=None),

        f"state/{timezone}/bbox_yaw": tf.io.FixedLenFeature([128, n_values], tf.float32, default_value=None),
        f"state/{timezone}/timestamp_micros": tf.io.FixedLenFeature([128, n_values], tf.int64, default_value=None),
        f"state/{timezone}/valid": tf.io.FixedLenFeature([128, n_values], tf.int64, default_value=None),
        f"state/{timezone}/vel_yaw": tf.io.FixedLenFeature([128, n_values], tf.float32, default_value=None)}
